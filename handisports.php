...
<div class="liste_handisport">
    <div class="rang">
        ...
        <button><img src="assets/img/SVG/force.svg" alt="icon basket"> <p>Force Athlétique</p></button>
        <button><img src="assets/img/SVG/tennis_de_table.svg" alt="icon basket"><p>Tennis de table</p></button>
    </div>

    <div class="rang">
        <button><img src="assets/img/SVG/tir_a_larc.svg" alt="icon basket"> <p>Tir à l'arc</p></button>
        <button><img src="assets/img/SVG/vitesse.svg" alt="icon basket"> <p>Course</p></button>
        <button><img src="assets/img/SVG/rugby_a_xiii.svg" alt="icon basket"><p>Rugby</p></button>
    </div>

    <div class="rang">
        <button><img src="assets/img/SVG/tennis_de_table.svg" alt="icon basket"> <p>Tennis de table</p></button>
        <button class="special"><img src="assets/img/SVG/tir.svg" alt="icon basket"> <p>Tir</p></button>
        <button class="special"><img src="assets/img/SVG/aquatique.svg" alt="icon basket"><p>Natation</p></button>
    </div>
